...
Serial.print("AT+HTTPPARA=");Serial.print('"');Serial.print("URL");Serial.print('"');Serial.print(',');Serial.print('"');Serial.print("http://api.thingspeak.com/update?key=154V2WPYDD17XH9S&field1=HUMIDITY ACTIVATED");Serial.print('"');Serial.print("\r\n");delay(3000);
